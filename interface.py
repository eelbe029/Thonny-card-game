...
class Carte:
    ...
    def __init__(self, couleur = 0, valeur = 2):
        images_trefle = [None, None, Image.open("Images/Trefle_0/02.png"),
        Image.open("Images/Trefle_0/03.png"),Image.open("Images/Trefle_0/04.png"),
        Image.open("Images/Trefle_0/05.png"), Image.open("Images/Trefle_0/06.png"),
        Image.open("Images/Trefle_0/07.png"), Image.open("Images/Trefle_0/08.png"),
        Image.open("Images/Trefle_0/09.png"), Image.open("Images/Trefle_0/010.png"),
        Image.open("Images/Trefle_0/011.png"), Image.open("Images/Trefle_0/012.png"),
        Image.open("Images/Trefle_0/013.png"), Image.open("Images/Trefle_0/014.png")]MANIPLER 
        images_carreau = [None, None, Image.open("Images/Carreau_1/12.png"),
        Image.open("Images/Carreau_1/13.png"),Image.open("Images/Carreau_1/14.png"),
        Image.open("Images/Carreau_1/15.png"), Image.open("Images/Carreau_1/16.png"),
        Image.open("Images/Carreau_1/17.png"), Image.open("Images/Carreau_1/18.png"),
        Image.open("Images/Carreau_1/19.png"), Image.open("Images/Carreau_1/110.png"),
        Image.open("Images/Carreau_1/111.png"), Image.open("Images/Carreau_1/112.png"),
        Image.open("Images/Carreau_1/113.png"), Image.open("Images/Carreau_1/114.png")]
        images_coeur = [None, None, Image.open("Images/Coeur_2/22.png"),
        Image.open("Images/Coeur_2/23.png"),Image.open("Images/Coeur_2/24.png"),
        Image.open("Images/Coeur_2/25.png"), Image.open("Images/Coeur_2/26.png"),
        Image.open("Images/Coeur_2/27.png"), Image.open("Images/Coeur_2/28.png"),
        Image.open("Images/Coeur_2/29.png"), Image.open("Images/Coeur_2/210.png"),
        Image.open("Images/Coeur_2/211.png"), Image.open("Images/Coeur_2/212.png"),
        Image.open("Images/Coeur_2/213.png"), Image.open("Images/Coeur_2/214.png")]
        images_pique = [None, None, Image.open("Images/Pique_3/32.png"),
        Image.open("Images/Pique_3/33.png"),Image.open("Images/Pique_3/34.png"),
        Image.open("Images/Pique_3/35.png"), Image.open("Images/Pique_3/36.png"),
        Image.open("Images/Pique_3/37.png"), Image.open("Images/Pique_3/38.png"),
        Image.open("Images/Pique_3/39.png"), Image.open("Images/Pique_3/310.png"),
        Image.open("Images/Pique_3/311.png"), Image.open("Images/Pique_3/312.png"),
        Image.open("Images/Pique_3/313.png"), Image.open("Images/Pique_3/314.png")]
...
#Titres
titre = ImageTk.PhotoImage(Image.open('Images/titrejeu.png'))
joueur1img = ImageTk.PhotoImage(Image.open('Images/Joueur1.png'))
joueur2img = ImageTk.PhotoImage(Image.open('Images/joueur2.png'))
fond_ecran.create_image(724,30,image=titre,anchor="nw")
joueur1 = fond_ecran.create_image(20,90,image=joueur1img,anchor="nw")
joueur2 = fond_ecran.create_image(20,590,image=joueur2img,anchor="nw")
...
boutton = ImageTk.PhotoImage(Image.open("Images/boutton.png"))
#Carte1
print(main1)
carte = ImageTk.PhotoImage(main1.cartes[0].img)
af_carte = fond_ecran.create_image(150,200,image=carte,anchor="nw")
global changer
changer = Button(root,text="",padx=40,pady=5,command = lambda :desactiver(1),borderwidth=0,bg="#145637",image=boutton)
...
global changer2
changer2 = Button(root,text="",padx=40,pady=5,command = lambda :desactiver(2),borderwidth=0,bg="#145637",image=boutton)
...
global changer3
changer3= Button(root,text="",padx=40,pady=5,command = lambda :desactiver(3),borderwidth=0,bg="#145637",image=boutton)
...
global changer4
changer4 = Button(root,text="",padx=40,pady=5,command = lambda :desactiver(4),borderwidth=0,bg="#145637",image=boutton)
...
global changer5
changer5 = Button(root,text="",padx=40,pady=5,command = lambda :desactiver(5),borderwidth=0,bg="#145637",image=boutton)
...
global changer6
changer6 = Button(root,text="",padx=40,pady=5,command = lambda :desactiver(6),borderwidth=0,bg="#145637",image=boutton)
...
global changer7
changer7 = Button(root,text="",padx=40,pady=5,command = lambda :desactiver(7),borderwidth=0,bg="#145637",image=boutton)
...
global changer8
changer8 = Button(root,text="",padx=40,pady=5,command = lambda :desactiver(8),borderwidth=0,bg="#145637",image=boutton)
...
global changer9
changer9 = Button(root,text="",padx=40,pady=5,command = lambda :desactiver(9),borderwidth=0,bg="#145637",image=boutton)
...
global changer10
print(main2)
changer10 = Button(root,text="",padx=40,pady=5,command = lambda :desactiver(10),borderwidth=0,bg="#145637",image=boutton)
...
img_btn_finjeu = ImageTk.PhotoImage(Image.open("Images/boutton_final.png"))
fin_jeu = Button(root,text="Lancer la partie",padx = 60,pady=10,command=lancer_le_jeu,borderwidth=0,bg="#145637",image=img_btn_finjeu)
fin_jeu.place(x=650,y=510)
